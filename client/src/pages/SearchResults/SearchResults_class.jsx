...
class SearchResults extends React.Component {
  ...
  componentDidMount() {
    ...
    let mapCen = [];
    mapCen[0] = (sortedDist[0].lat + sortedDist[sortedDist.length - 1].lat) / 2;
    mapCen[1] = (sortedDist[0].lng + sortedDist[sortedDist.length - 1].lng) / 2;
    this.setState({ searchResults: postList, mapCen });
            ...
            <Map
              ...
              {this.state.searchResults.map((post) =>
                <Marker
                  ...
                  onClick={() => { this.selectedMarker(post.zipcode) }}
                />)
              }
            </Map>
